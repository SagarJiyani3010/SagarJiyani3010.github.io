!(function (e) {
  ...
  e(function () {
    e(document).on("click", 'a[data-scroll][href^="#"]', function (a) {
      ...
      0 !== i.length &&
        (a.preventDefault(),
        e("body, html").animate({ scrollTop: i.offset().top }, 600));
    }),
      e("body").scrollspy({ target: ".sidebar .list-menu" }),
      e(".sidebar .list-menu")
        .clone()
        .children()
      ...
      e(document).on("mouseup", function (a) {
        if (
          e(".mobile-navbar #mobileNavbarSupportedContent").hasClass("show")
        ) {
                ...
                (t = a),
                  ...
                  (function (e, a) {
                    e.parents(".cd-headline").hasClass("clip") &&
                      e
                        .parents(".cd-words-wrapper")
                        .animate({ width: e.width() + 10 }, n, function () {
                          setTimeout(function () {
                            s(e);
                          }, o);
                        });
      ...
      e(".home-area").hasClass("video-variant")
        ? e("#homeVideo").YTPlayer()
        : e(".home-area").hasClass("particles-variant")
        ? particlesJS("particles-js", {
            particles: {
              ...
              opacity: {
                value: 0.7,
                random: !1,
                anim: { enable: !1, speed: 3, opacity_min: 0.1, sync: !1 },
              },
              size: {
                value: 5,
                random: !0,
        ...
        : e(".home-area").hasClass("galaxy-variant")
        ? particlesJS("particles-js", {
            particles: {
        ...
        : e(".home-area").hasClass("snow-variant")
        ? particlesJS("particles-js", {
            particles: {
              number: { value: 50, density: { enable: !0, value_area: 800 } },
              color: { value: "#fff" },
        ...
        : e(".home-area").hasClass("bubble-variant") &&
          particlesJS("particles-js", {
            particles: {
              number: { value: 4, density: { enable: !0, value_area: 800 } },
              color: { value: "#ffffff" },
              shape: {
                type: "circle",
      ...
      e(".contact").on("submit", function (a) {
        var t = e(this),
              ...
              "success" == e
                ? (i.removeClass("wait").html("Success").addClass("success"),
                  o
                    ...
                    .fadeIn(200),
                  setTimeout(function () {
                    i.html(n).removeClass("success").prop("disabled", !1),
                ...
                : (console.log(e),
                  ...
                  o
                    ...
                    .fadeIn(200),
                  setTimeout(function () {
                    i.html(n).removeClass("error").prop("disabled", !1),
    ...
    e(window).on("load", function () {
      ...
      e(".preloader-icon").fadeOut(400),
        ...
        (a = e(".portfolio-area .portfolio-grid")),
        (t = e(".portfolio-area .filter-control li")),
        a.isotope({ itemSelector: ".single-item" }),
        t.on("click", function () {
          t.removeClass("tab-active"), e(this).addClass("tab-active");
          var i = e(this).data("filter");
          a.isotope({ filter: i, transitionDuration: ".25s" });
        }),
        e(".portfolio-area .portfolio-grid .portfolio-item").each(function () {
          ...
          e(a).animatedModal({
            ...
            afterClose: function () {
              e(t + ".lightbox-wrapper .lightbox-gallery").trigger(
